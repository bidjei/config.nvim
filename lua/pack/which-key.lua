...
key.setup {
	...
	spec = {
		...
		},
		{
			...
			{ "T",    "<C-w><C-h>",                        desc = "Move window Left" },
			{ "S",    "<C-w><C-l>",                        desc = "Move window Right" },
			{ "N",    "<C-w><C-j>",                        desc = "Move window Below" },
			{ "L",    "<C-w><C-k>",                        desc = "Move window Above" },
			{ "H",    "T",                                 desc = "Move window Above" },
			{ "J",    "K",                                 desc = "Move window Above" },
			{ "K",    "N",                                 desc = "Move window Above" },
