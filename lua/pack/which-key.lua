...
key.setup {
	...
	spec = {
		...
		},
		{
			...
			{ "<C-w>t", "<C-w>h", desc = "Move Left" },
			{ "<C-w>s", "<C-w>l", desc = "Move Right" },
			{ "<C-w>n", "<C-w>j", desc = "Move Below" },
			{ "<C-w>l", "<C-w>k", desc = "Move Above" },

			{ "<C-w>T", "<C-w>H", desc = "Move window Left" },
			{ "<C-w>S", "<C-w>L", desc = "Move window Right" },
			{ "<C-w>N", "<C-w>J", desc = "Move window Below" },
			{ "<C-w>L", "<C-w>K", desc = "Move window Above" },
